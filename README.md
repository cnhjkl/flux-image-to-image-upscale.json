# flux-image-to-image-upscale.json

Dockerized ComfyUI workflow: Flux Image to Image Upscale.json
...
docker build -t flux-image-to-image-upscale.json .

# Run the container
docker run -p 8188:8188 flux-image-to-image-upscale.json
```
